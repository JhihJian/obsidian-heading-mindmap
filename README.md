...
- Double-click the body in reading mode to enter editing mode.
...
- 下方正文区域默认显示 Markdown 阅读效果，右上角按钮可切换到源码编辑视图；阅读模式下双击正文也会进入编辑视图，也可最小化为标题栏。
- 工具栏提供快捷键速查表。
